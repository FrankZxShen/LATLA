...
class BaseModel(nn.Module):
    ...
    def __call__(self, sample_list, model_llama2=None, question_str=None, ocr_tokens=None, *args, **kwargs):
        ...
        if "metrics" in model_output:
            ...
            model_output["metrics"] = self.metrics(sample_list, model_output, model_llama2, question_str, ocr_tokens)
