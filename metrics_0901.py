...
class TextVQAAccuracy(BaseMetric):
    ...
    def calculate(self, sample_list, model_output, model_llama2, question_str, ocr_tokens, *args, **kwargs):
        ...
        accuracy = self.evaluator.eval_pred_list(predictions, model_llama2, question_str, all_gt_answers, ocr_tokens)
...
class PreTrainMLMAccuracy(BaseMetric):
    ...
    def calculate(self, sample_list, model_output, model_llama2, *args, **kwargs):
        ## (B,T,token), (B,T)
