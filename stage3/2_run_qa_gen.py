...
def main():
    ...
    parser.add_argument('-c', '--caption', default='/DATACENTER1/szx/tap/data/ablations_json/abl_caption_val_caption+ocr+fitclip1107.json', help='path to caption file')
    parser.add_argument('-q', '--qagen', default='/DATACENTER1/szx/tap/data/ablations_json/abl_qa_gen_val_caption+ocr+fitclip1107.json', help='path to qa file')
    ...
    with torch.inference_mode():
        ...
        for img_caption in tqdm(all_captions, disable=disable_tqdm):
            ...
            single_qa_gen['answer'] = img_caption['Answer']
