...
def main():
    ...
    parser.add_argument('-llmo', '--llmout', default='/DATACENTER1/szx/tap/data/mid_json/val_llm_gen_1119_vqa_1600.json', help='path to llm gen file')
    parser.add_argument('--lora', default='/home/szx/project/llama2-lora-fine-tuning/datasets/lora_weights/10-16/checkpoint-1600/', help='path to lora')
    ...
    for qa in tqdm(all_qa_gen, disable=disable_tqdm):
        ...
        LLMPrompt = (
            ...
            + qa['pred_answer']
            + "\n"
            + "Based on the Questions and Answers above, answer the following question using a single word or phrase. The true answer may not be the Predict Answer.\n"
            + "Question: "
            + qa["question"]
            + "\n"
            + "Answer: "
